...
---
*Last updated: 2026-08-09 after Phase 38 (Tabela de Custos por Operação) complete and F38.1 (Apuração de Custos de IA por Entrega) CONCLUÍDA (11/11 plans, 1713 testes, UAT validado — fechada como estimativa operacional granular: `responses:image_generation = 0.065` provisório beta, reconciliação financeira real na próxima fase) — v1.5 segue com F37 (Revisão e Aprovação da Arte) em planejamento; F39 (Stripe) futura pós-beta*

...
- [ ] 46-02-PLAN.md — api-keys + gateway (`invoke`/alvo explícito/uma tentativa) + adapters por protocolo + `AiCallEnvelope` (`extends AiCallInfo`) + contrato de erro + sink + mapa capability→generationType (Wave 2)

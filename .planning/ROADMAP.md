...
**Status:** Em execução — 19/19 plans (8 waves)
...
*Last updated: 2026-09-10 — F45 concluída (8/8 plans, 2427 testes, UAT PASS 7/7) e incorporada à F37, que permanece em execução por fatias: 37.1 concluída (15/15 plans, 2379 testes, UAT PASS 6/6); **37.2 realinhada (Correção Única por Não Conformidade) em execução — 19/19 plans (8 waves), fonte `openspec/changes/fase-37-2-correcao-unica-por-nao-conformidade/`**; **37.3 eliminada** (consolidada na 37.2). F44 e Stripe permanecem fora da numeração.*

...
**Status:** Concluída — 19/19 plans (8 waves), 4 gates verdes (264 files / 2577 testes), UAT PASS 9/9 (37.2-6 validado por código)
...
*Last updated: 2026-09-10 — F45 concluída (8/8 plans, 2427 testes, UAT PASS 7/7) e incorporada à F37. **F37.2 realinhada (Correção Única por Não Conformidade) CONCLUÍDA — 19/19 plans (8 waves), 264 files / 2577 testes, 4 gates verdes (vitest/typecheck/lint/build), UAT PASS 9/9 (37.2-6 validado por código), migrations `20260906000001/2/3` aplicadas no remoto; fix pós-UAT `01a7021b` (análise textual + erros 409 legíveis)**; 37.1 concluída (15/15 plans, 2379 testes, UAT PASS 6/6); **37.3 eliminada** (consolidada na 37.2). F44 e Stripe permanecem fora da numeração.*

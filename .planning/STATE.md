...
**Current phase:** 43
**Last activity:** 2026-08-25 - Completed quick task 260825-cad: Corrigir cadastro de loja em /loja e admin
...
| 260825-cad | Corrigir cadastro de loja em /loja e admin — mapeia decisao interna `reject` para `verification_status='rejected'` antes dos RPCs `create_store_with_cnpj` e `update_store_cnpj`; desativa criacao de loja de producao via `POST /api/admin/stores` com `410 admin_store_creation_disabled`; remove formulario admin normal e mantem somente CTA de store de teste. 35 testes focados verdes + typecheck limpo | 2026-08-25 | pending | [260825-cad-corrigir-cadastro-loja-admin](./quick/260825-cad-corrigir-cadastro-loja-admin/) |

...
**Current phase:** 46
**Last activity:** 2026-09-13 — Completed quick task 260913-qq6: Remover checkbox obrigatória de privacidade do signup e adicionar modo informativo read-only ao PrivacyAcknowledgeModal
...
Phase: 37 (RevisÃ£o e AprovaÃ§Ã£o da Arte) â€” fatia 37.1 (Approval Gate + Candidata Ãšnica) **CONCLUÃDA** (37.2 realinhada CONCLUIDA; 37.3 eliminada)
Plan: 15/15 complete (fatia 37.1)
...
| 260913-qq6 | Remover checkbox obrigatória de privacidade do signup — microcopy "Ao clicar em Criar conta, você concorda com os Termos de Uso e declara ciência da Política de Privacidade do Vendeo." com "Termos de Uso"/"Política de Privacidade" como âncoras reais (/termos, /privacidade) interceptadas no clique normal para abrir PrivacyAcknowledgeModal mode="informative" (read-only, sem checkbox/confirmar) reutilizado para os dois documentos; modo acknowledge preservado como default para PrivacyGate/legal-status-section (privacy-gate.test.tsx verde sem edição); setPrivacyPending() intacto (privacyAcknowledged: true + communicationsOptIn real); opt-in de comunicações opcional/desmarcado; signup/page.tsx passa termsDocument; specs signup-page/privacy-acknowledgement sincronizadas. 3 tasks, 7 arquivos (1 novo), 4 gates verdes (34 testes focados + typecheck + lint + build) | 2026-09-13 | b3c1fdd6 | [260913-qq6-remover-checkbox-obrigatoria-de-privacid](./quick/260913-qq6-remover-checkbox-obrigatoria-de-privacid/) |

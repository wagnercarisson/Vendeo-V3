...
### Phase 46 — Gateway Único de IA e Registry de Modelos ◆ Em planejamento (0/9 plans / 9 waves)
...
| 46-02 | 2 | ○ | api-keys + gateway + adapters por protocolo + `AiCallInfo` estendido + contrato de erro + sink + mapa capability→generationType |

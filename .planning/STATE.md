...
**Current phase:** 50
**Last activity:** 2026-09-21 - Executando Phase 50 (Demonstração Gratuita e Validade dos Créditos) — 50-05 ✅ (rotas demo + first_generation)
...
**Execução adicional:** 50-05 ✅ (rotas demo e `first_generation` após sucesso, dedup por `origin_demo_grant_tx_id`, 80 testes de geração).

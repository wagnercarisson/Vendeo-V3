...
| 42-10 | ✅ escrito | Landing — flag on: CTA principal "Continuar com Google" (GoogleButton) + secundário "Continuar com email" → /signup, sem form; flag off: "Solicitar acesso free" + form; `access_requests` como histórico (D4/D15) | 3 | 42-02, 42-07 | access-request-history, signup-page, google-oauth-signup |
...
| 42-13 | ✅ escrito | Testes 1–13 — Signup/flag/landing/OAuth UI (13 testes; Teste 10 trava "Continuar com Google" principal, sem alternativas) | 4 | 42-06, 42-07, 42-08, 42-10 | signup-page, google-oauth-signup, login-page, access-request-history |

...
|---|---|---|
| `campaign-image-director.md` (base/referência offer) | "Você é o Diretor de Marketing da {{storeName}}... A peça deve ser publicável, comercial e transmitir confiança ao lojista." | Oferta/geral: framing promocional; composição nº 4 "Exibir o preço com desconto informado nos fatos como preço principal"; hierarquia produto > preço > loja > CTA; badge obrigatório quando informado; composição limpa/profissional (sem flat rígido). |
| `campaign-image-director-offer.md` | idem base (espelho runtime do intent offer) | Promocional; preço com desconto + original riscado; badge promocional obrigatório quando informado; CTA complementa sem repetir badge; hierarquia produto > preço > loja > CTA; composição limpa/profissional. |
...
| `campaign-image-director-exclusive.md` (atualizado no F45-06b) | "Briefing: Campanha Visual para Instagram — **Exclusivo**... O produto deve ser apresentado com **valor percebido premium — sem divulgação de preço**. Exclusividade e diferenciação devem vir dos atributos informados; condições como 'edição limitada' ou disponibilidade restrita somente quando estiverem explícitas no briefing." | Instrução nº 1 "NÃO exibir preço, desconto, condições de pagamento ou parcelamento"; badge "NÃO usar badges promocionais"; badge informado obrigatório; CTA complementa sem repetir badge; sem flat rígido (composição premium com luz/sombra); sem parágrafo fixo de preserveImageContext/flores/outros (full-bleed só no bloco contextual quando preserve ativo); hierarquia produto > loja > CTA. |

...
| 45-03 | ○ Planejado | Reescrita offer + base (estrutura editorial + blocos contextuais, mão leve) + montagem contextual offer no helper + deduplicação + `validatePrompts`/`assemblePrompt` + saneamento nos blocos novos (tasks 3.1–3.6) | 2 | 45-02 | F45-08, F45-09, F45-10, F45-11, F45-12, F45-13 |

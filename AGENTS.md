...
| 46-02 | 2 | ○ | api-keys + gateway (`invoke`/alvo explícito/uma tentativa) + adapters por protocolo + `AiCallInfo` estendido + contrato de erro + sink + mapa capability→generationType (tasks 2.1–2.6) |

...
- [ ] Phase 50: Demonstração Gratuita e Validade dos Créditos (◆ Executando — 11/17 plans / 10 waves)
  ...
  - **Status:** ◆ Executando (11/17 plans / 10 waves; 50-01 ✅ trackings + baseline + inventário; 50-02 ✅ migration estrutural; 50-03 ✅ RPCs SQL + smoke tests PASS; 50-04 ✅ serviços de crédito/demo; 50-05 ✅ rotas e first_generation; 50-06 ✅ reconciliador e suporte; 50-07 ✅ notificações/outbox/email/in-app; 50-08 ✅ ProductEventService; 50-09 ◐ UI demo/status com apresentação visual e fluxo sem campanhas pendentes; 50-10 ✅ legal consolidado + template fora da fila automática; 50-11 ○ bloqueado por ausência de harness Supabase/PostgreSQL local; 50-15 ✅ storage privacy + smokes HTTP e fluxos focados; 50-17 ✅ runbook de backup externo — base técnica OpenSpec composta em 2026-09-20)

...
O sistema SHALL implementar `BalanceCard` em `src/components/credit/balance-card.tsx` como Server Component que exibe um card de saldo completo para a página `/conta`.

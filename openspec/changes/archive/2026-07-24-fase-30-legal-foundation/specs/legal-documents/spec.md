...
### Requirement: Legal document drafts in docs/legal/

The system SHALL include three draft legal documents in `docs/legal/`:
...
- Link to the corresponding markdown file in `docs/legal/`

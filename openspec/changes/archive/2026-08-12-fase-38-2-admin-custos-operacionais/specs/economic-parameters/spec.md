...
O sistema SHALL prover a classe `EconomicParameterService` em `src/lib/economic/economic-parameter-service.ts` (server-only, padrão `OperationCostService` F38):

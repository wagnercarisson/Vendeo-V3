...
O sistema SHALL prover `normalizeCity(city: string): string` que normaliza a cidade removendo acentos, convertendo para maiúsculas, e removendo espaços extras para comparação (inalterado — F33).

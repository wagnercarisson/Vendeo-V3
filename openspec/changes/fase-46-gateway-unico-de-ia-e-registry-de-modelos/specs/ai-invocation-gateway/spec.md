...
> Capability nova (ADDED) pela `fase-46-gateway-unico-de-ia-e-registry-de-modelos`. Define a camada única de execução de chamadas de IA com adapters por protocolo, contrato único de request/result/usage e telemetria obrigatória por chamada.

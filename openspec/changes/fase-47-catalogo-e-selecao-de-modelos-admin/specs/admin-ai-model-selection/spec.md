...
> Capability nova (ADDED) pela `fase-47-catalogo-e-selecao-de-modelos-admin`. Define a tela administrativa e a API para escolher e versionar os modelos por capacidade, controlando primary e fallback somente onde há caller real, agrupados por Texto/Visual/Imagem.

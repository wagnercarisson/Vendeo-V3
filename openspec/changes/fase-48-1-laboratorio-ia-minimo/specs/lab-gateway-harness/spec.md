...
> Capability nova (ADDED) pela `fase-48-1-laboratorio-ia-minimo`. Define o seam laboratorial que reutiliza o gateway/adapters da F46 e o catálogo da F47 com alvo fixo do experimento e sem fallback automático, sem tocar a seleção produtiva.

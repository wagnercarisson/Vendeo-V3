...
- [x] 10.2 **Migration de publicação separada** das três versões (`terms_of_service v1.5`, `privacy_policy v1.4`, `acceptable_use v1.2`), após validação jurídica, `effective_at` coordenado com o corte

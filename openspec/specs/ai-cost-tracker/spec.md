...
O sistema SHALL estender o contrato de custo call-level para aceitar o novo tipo da análise do relato (F37.2 — achado 4 — fonte normativa principal atualizada):

...
Tabela versionada de preços de modelos de IA (`ai_model_pricing`) consumida por `resolveAiCost`, com RPC auditada de versionamento, API admin de leitura/atualização e verificação, ciente da capacidade, do pricing exigido pelos modelos selecionáveis.

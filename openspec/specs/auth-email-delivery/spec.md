...
Configuração de SMTP (Resend.com), templates PT-BR no Supabase Dashboard, DNS (DKIM/DMARC/SPF), e Vercel Preview para UAT de deliverability. Validação com Gmail e Outlook.

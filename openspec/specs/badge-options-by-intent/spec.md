# Badge Options By Intent

> Added by `fase-31-1-modelo-comercial-formulario`.

## Purpose

Define as opções de badge disponíveis para cada intenção comercial (`offer`, `spotlight`, `exclusive`). Mantém compatibilidade retroativa com `BADGE_OPTIONS`.

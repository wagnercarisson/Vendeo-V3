> **Propósito**: Componente `BalanceDisplay` — Server Component reutilizável que exibe o saldo de créditos com variantes visuais (badge, card, inline) e estados baseados no valor do saldo (normal, baixo, zero, sem loja).
>

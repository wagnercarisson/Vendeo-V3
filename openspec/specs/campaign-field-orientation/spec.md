...
Conteúdo de orientação dos campos da campanha em `/campanhas/nova`: descrição do produto (apenas copy/publicação), preços/intenção com feedback dinâmico preservando as 3 regras atuais, informações obrigatórias na arte (multi-linha, visível) e as fronteiras canônicas entre áreas — sem alterar body, prompts ou pipeline.

> Added by `fase-49-ativacao-orientacao-contextual-campos` (D8/D9/D10/D11/D14).

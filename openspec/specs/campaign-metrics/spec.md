...
> Created from `fase-20-dashboard` (ADDED). Aggregated metrics helpers for campaign data: counts, success rate, recent campaigns, and backward compatibility reexport.

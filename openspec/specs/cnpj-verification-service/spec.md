...
Classe `CnpjVerificationService` que orquestra consulta de CNPJ através do pipeline: cache → provedor primário (BrasilAPI) → provedor fallback (CNPJá), com cache de resultados e tratamento de indisponibilidade.

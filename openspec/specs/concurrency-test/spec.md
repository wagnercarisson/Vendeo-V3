...
Teste de pipeline concorrente com mocks — dois requests simultâneos para o mesmo endpoint, mesma loja, saldo disponível de 1 crédito, validando que apenas um vence e o outro recebe 402.

> **Propósito**: Esta spec define a página de conta do usuário (`/conta`) dentro do route group `(app)/`. Exibe informações básicas da conta, link para alterar senha e botão de logout.
>
...
- UI sections in Cards: Informações da Conta (email), Segurança (alterar senha), Sessão (logout)

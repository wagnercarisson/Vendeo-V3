...
Página `/forgot-password` com formulário de solicitação de redefinição de senha. Anti-enumeration: sempre redireciona para `/check-email` independente de sucesso ou erro.

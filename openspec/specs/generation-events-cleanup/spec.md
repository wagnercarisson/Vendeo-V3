# Generation Events Cleanup

> Synced from `fase-28-observabilidade-operacao-launch-controls` (ADDED).

## Purpose

Função SQL versionada para cleanup manual de `generation_events` com retenção de 90 dias, definida via migration sem executar DELETE automaticamente. Job automático adiado para fase posterior.

...
Defines the global timeout mechanism that bounds total generation duration, the per-phase monitoring windows (diagnostic only), and the AbortSignal propagation to provider calls.

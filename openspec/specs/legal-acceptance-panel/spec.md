...
Defines the global legal acceptance side panel shown on `/loja` across all onboarding tabs, and the hard-block rule that ties the Posicionamento tab to a valid legal acceptance.

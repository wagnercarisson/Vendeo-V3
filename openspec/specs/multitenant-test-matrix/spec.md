...
Parametric test matrices for multi-tenant perimeter: storeId-scoped endpoints (20+ routes), current-store endpoints, POST /api/store creation, and CSRF mutation coverage.

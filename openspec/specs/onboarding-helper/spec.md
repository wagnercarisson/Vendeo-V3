...
> Created from `fase-19-onboarding-estados-vazios` (ADDED). Centralized onboarding state detection, campaign counting, and microcopy for empty states across the app.

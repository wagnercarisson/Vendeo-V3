...
Helper central de logging estruturado para o pipeline de geração, emitindo JSON via `console.log` com campos obrigatórios, sanitização de dados sensíveis e comportamento fire-and-forget.

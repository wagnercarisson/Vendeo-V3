...
Persistência best-effort de telemetria de IA em `generation_events` após Copy Director, Image Director e pipeline completo, incluindo custo estimado, tokens, provedor e metadados.

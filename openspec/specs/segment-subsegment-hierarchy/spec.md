> **Propósito**: Define a hierarquia de segmentos e subsegmentos que categoriza lojas no sistema, substituindo os antigos `VALID_SEGMENTS`/`SEGMENT_LABELS` por uma estrutura unificada `STORE_SEGMENTS` + `STORE_SUBSEGMENTS`.

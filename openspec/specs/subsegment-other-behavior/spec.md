> **Propósito**: Define o comportamento do campo "Outro" nos subsegmentos — quando o lojista seleciona "Outro" em um segmento rico ou está no segmento "Outros", um campo de texto livre obrigatório é exibido com validação client-side e server-side.

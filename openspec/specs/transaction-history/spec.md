> **Propósito**: Componente `TransactionHistory` — Client Component que exibe o extrato de transações de crédito em tabela paginada, com mapeamento de tipos e navegação via searchParams.
>

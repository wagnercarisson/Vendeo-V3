...
import { OPERATION_LABELS } from "@/lib/credit/types";
  ...
  return (
    <div className="space-y-4 overflow-x-auto">
      <p className="text-xs text-muted-foreground">
        Alterações não valem em produção até salvar (motivo obrigatório +
        auditoria). A habilitação das operações é controlada em{" "}
              ...
              <tr key={row.operationKey} className="border-b align-top">
                <td className="py-3 pr-3">
                  <div className="text-sm font-medium">
                    {OPERATION_LABELS[row.operationKey]}
                  </div>

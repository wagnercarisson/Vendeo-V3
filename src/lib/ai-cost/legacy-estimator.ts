/**
 * @deprecated Use `resolveAiCost` de `./cost-estimator` — este wrapper é removido
 * em 38-1-07. Mantido como SÍNCRONO para a rota generate-image continuar
 * compilando: NÃO chama o resolvedor async (impossível com `await` em chamador
 * síncrono). Fallback/defaults locais — o contrato F28 é preservado intacto.
 */
...
// Cópia local LEGADA: lê APENAS o env antigo — não se mistura com
// VENDEO_AI_FALLBACK_COST_USD (novo, em cost-estimator.ts).
